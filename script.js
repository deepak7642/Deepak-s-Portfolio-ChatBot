...
MS SQL<br><br> <span class='bold'>Data Visualization</span><br>Tableau<br><br> <span class='bold'>Deployment</span><br>Streamlit<br>Flask<br>Gradio</span>");
        ...
        case "experience":
            sendTextMessage("💼 <span class='bold'>Work Experience</span><br><br> <span class='bold'>Farmoid Robotech Pvt Ltd</span><br><br> i) Developed and deployed AI-driven AgriTech solutions including Commodity Market Price Forecasting, Crop Yield Prediction, Crop Stage Advisory, and Soil Health Monitoring powering the Farmoid mobile app.<br><br> ii) Designed the <span class='bold'>Farmoid AI Chatbot</span> (“Kisan Ke Sawalon Ka AI Jawaab”) using LLM frameworks to assist farmers with real-time answers in regional languages.<br><br> iii) Led the AI/ML team across the full lifecycle — research, experimentation, and deployment via Streamlit, Gradio, and Flask.<br><br> iv) Increased farmer profitability by <span class='bold'>35–40%</span> through AI-driven forecasting and advisory systems.<br><br> <span class='bold'>Rework AI</span><br><br>  i) Led development of AI-powered HR automation tools including GPT/LLM-based job description generation and NLP-driven resume–JD matching systems deployed on the company website.<br><br> ii) Improved JD matching accuracy by <span class='bold'>25%</span> by building automated NLP pipelines processing 1,000+ resumes.<br><br> <span class='bold'>Resolute.AI</span><br><br> i) Designed predictive analytics proof-of-concepts and presented them directly to the Co-Founder and senior leadership.<br><br> ii) Architected and deployed a predictive analytics solution later adopted as a flagship feature on the corporate website, serving as a key client engagement tool.");

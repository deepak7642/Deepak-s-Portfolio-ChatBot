...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Namaste 🙏,<br><br>My name is <span class='bold'><a class='alink'>Deepak Kaura</a>.</span><br><br><span class='bold'>AI/ML Developer with 3.2 years of experience</span> building Predictive Analytics and LLM applications.<br><br>Send <span class='bold'>'help'</span> to know more about me.<br>");
            }, 2000);
            break;
        case "help":
            ...
            break;
function showOtherOptions(current){
    let commands = ["skills","resume","education","contact","experience","awards","about","clear"];

    commands = commands.filter(cmd => cmd !== current);

    let suggestion = "<br><br><span class='sk'>You can also try:<br>";

    commands.forEach(cmd=>{
        suggestion += "<span class='bold'>" + cmd + "</span><br>";
    });
...
MS SQL<br><br> <span class='bold'>Data Visualization</span><br>Tableau<br><br> <span class='bold'>Deployment</span><br>Streamlit<br>Flask<br>Gradio</span>");
        ...
        case "education":
            ...
            showOtherOptions("education");
            break;

        case "experience":
            sendTextMessage("💼 <span class='bold'>Work Experience</span><br><br> <span class='bold'>Farmoid Robotech Pvt Ltd</span><br><br>  • Developed and deployed AI-driven AgriTech solutions including Commodity Market Price Forecasting, Crop Yield Prediction, Crop Stage Advisory, and Soil Health Monitoring powering the Farmoid mobile app.<br><br> • Designed the <span class='bold'>Farmoid AI Chatbot</span> (“Kisan Ke Sawalon Ka AI Jawaab”) using LLM frameworks to assist farmers with real-time answers in regional languages.<br><br> • Led the AI/ML team across the full lifecycle — research, experimentation, and deployment via Streamlit, Gradio, and Flask.<br><br> • Increased farmer profitability by <span class='bold'>35–40%</span> through AI-driven forecasting and advisory systems.<br><br> <span class='bold'>Rework AI</span><br><br>  • Led development of AI-powered HR automation tools including GPT/LLM-based job description generation and NLP-driven resume–JD matching systems deployed on the company website.<br><br> • Improved JD matching accuracy by <span class='bold'>25%</span> by building automated NLP pipelines processing 1,000+ resumes.<br><br> • Recognized by senior management for exceptional contribution and performance during the internship.<br><br> <span class='bold'>Resolute.AI</span><br><br>  • Designed predictive analytics proof-of-concepts and presented them directly to the Co-Founder and senior leadership.<br><br> • Architected and deployed a predictive analytics solution later adopted as a flagship feature on the corporate website, serving as a key client engagement tool.");
            showOtherOptions("experience");
            break;
        case "awards":
